...
% 加载中文环境支持，字体使用adobe套装
% 可选配置为
% fontset = <adobe|fandol|founder|mac|macnew|macold|ubuntu|windows|none|xxx>
% 或者自定义字体配置，配合ctex-fontset-xxx.def使用
% ctex-fontset-custom.def为自定义示例文件
