...
% 这个必须留着！
\name{ACV-Dukang}{手册}
\dukangPDFTitle{Awesome-CV-Dukang手册}
% 首页的图片Logo
...
% 独立引用每个文件，或者直接书写正文
%-------------------------------------------------------------------------------
\input{dukang-doc/00-cover.tex}
\input{dukang-doc/01-intro.tex}
\input{dukang-doc/02-arch.tex}
\input{dukang-doc/03-usage.tex}
\input{dukang-doc/04-comp.tex}
\input{dukang-doc/05-update.tex}
%-------------------------------------------------------------------------------
